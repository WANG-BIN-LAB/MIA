...
def model_training(cfg: DictConfig):
    """
    Training pipeline for a single fold in 5-fold cross-validation
    Args:
...
def main(cfg: DictConfig):
    ...
    - 5-fold stratified cross-validation (handled by dataset loader)
    """
    ...
    for _ in range(cfg.repeat_time):
        # Loop: 5-fold cross-validation (fold 0 ~ 4)
        for fold_idx in range(5):
            ...
            run = wandb.init(
                ...
                tags=[cfg.dataset.name, "5-fold-CV"]
            )
