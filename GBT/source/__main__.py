...
def model_training(cfg: DictConfig, lds, ld1, ld2, fold: int):
    """
    Execute training process for single fold
    """
    with open_dict(cfg):
...
def main(cfg: DictConfig):
    ...
    NUM_FOLDS = 5
    # Container to store metrics of all folds
    metric_records = {
        "accuracy": [],
        "auc": [],
        "sensitivity": [],
    ...
    print("\n" + "=" * 80)
    print("START 5-FOLD STRATIFIED CROSS-VALIDATION")
    print("=" * 80)
    ...
    # Calculate and print final statistics: Mean ± Std
    print("\n" + "=" * 80)
    print("FINAL 5-FOLD CROSS-VALIDATION RESULTS (MEAN ± STD)")
    print("=" * 80)
