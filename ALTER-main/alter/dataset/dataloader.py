...
def init_dataloader(cfg: DictConfig,
    ...
    """
    Create dataloaders using 5-fold stratified cross-validation
    Args:
        cfg: Hydra config
    ...
    # Fixed 5-fold split with reproducible seed
...
def init_stratified_dataloader(cfg: DictConfig,
    ...
    """
    Stratified dataloader for balanced label distribution in 5-fold CV
    Args:
        cfg: Hydra config
        final_timeseires: Time series features
        final_pearson: Pearson matrix features
