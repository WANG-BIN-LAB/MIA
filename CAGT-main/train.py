...
from model.utils import isfloat
...
def load_args():
    ...
    parser.add_argument('--seed', type=int, default=42,
                        help='random seed')
    parser.add_argument('--root_dir', type=str, default="F:\small_paper\dataset\ABIDE\ABIDE_cc200\Outputs\cpac\\filt_noglobal", help='root path')
...
def main():
    ...
    dataset = ABIDEDataset(path,"rois_cc200")
